...
bigscape cluster -i /home/bio.aau.dk/zs85xk/projects/epsSMASH/epsSMASH_paper/bigscape/MFD/regions -o epsSMASH_paper/bigscape/MFD/output -p bigscape/pfam/Pfam-A.hmm -c 60 --force-gbk --gcf-cutoffs 0.4