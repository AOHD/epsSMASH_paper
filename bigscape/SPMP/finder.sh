cut -f 1 epsSMASH_paper/data/SPMP/SPMP_species_rep_genome_ids.tsv | while read -r filename; do
    echo "Processing $filename"
    src_dir="epsSMASH_analyses/SPMP/data/epsSMASH_results_SPMP_hybrid/antismash/$filename"
    dest_dir="epsSMASH_paper/bigscape/SPMP/regions"
