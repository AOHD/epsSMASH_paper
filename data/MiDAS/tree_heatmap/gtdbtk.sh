...
WD=/home/bio.aau.dk/zs85xk/projects/epsSMASH/epsSMASH_paper/data/MiDAS/tree_heatmap
cd $WD
...
cut -f 1 /home/bio.aau.dk/zs85xk/projects/epsSMASH/epsSMASH_paper/data/MiDAS/heatmap_tree_genomes.tsv | while read -r filename; do
    echo $filename
