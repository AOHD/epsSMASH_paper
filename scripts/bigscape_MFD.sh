...
bigscape cluster -i epsSMASH_paper/results/bigscape/MFD/regions -o epsSMASH_paper/results/bigscape/MFD/output -p bigscape/pfam/Pfam-A.hmm -c 60 --force-gbk --gcf-cutoffs 0.4