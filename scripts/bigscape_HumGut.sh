...
bigscape cluster -i epsSMASH_paper/data/HumGut/epsSMASH_results/antismash -o epsSMASH_paper/results/bigscape/HumGut/output -p bigscape/pfam/Pfam-A.hmm -c 60 --force-gbk --gcf-cutoffs 0.4